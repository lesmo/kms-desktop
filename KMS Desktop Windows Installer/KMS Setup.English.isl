...
SetupFileMissing=The file %1 is missing from the installation directory. Please correct the problem or obtain a new copy of this setup file.
SetupFileCorrupt=The setup files are corrupted. Please obtain a new copy of this setup file.
SetupFileCorruptOrWrongVer=The setup files are corrupted, or are incompatible with this version. Please correct the problem or obtain a new copy of this setup file.
...
ExitSetupMessage=Setup is not complete. If you exit now, this setup file will not be installed.%n%nYou may run Setup again at another time to complete the installation.%n%nExit Setup?
...
SelectStartMenuFolderDesc=Where should Setup place this setup file's shortcuts?
SelectStartMenuFolderLabel3=Setup will create this setup file's shortcuts in the following Start Menu folder.
