...
namespace KMS.Comm.Cloud.OAuth {
    ...
    public sealed class OAuthCryptoSet {
        ...
        /// <summary>
        /// Crear un nuevo conjunto de Token y Secret, o Consumer Key (API-Key de KMS)
        /// y Secret (API-Secret de KMS) de OAuth
        /// </summary>
        /// <param name="key">Token o Consumer Key (API Key de KMS)</param>
        /// <param name="secret">Token Secret o Consumer Secret (API Secret de KMS)</param>
